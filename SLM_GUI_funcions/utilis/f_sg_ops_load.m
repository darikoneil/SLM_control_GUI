function f_sg_ops_load(app, varargin)
...
def_region_params.SLM_name = app.SLM_ops.SLM_type;
...
for n_reg = 1:numel(load_data.region_obj_params)
    temp_region_obj_params(n_reg) = f_copy_fields(def_region_params, load_data.region_obj_params(n_reg));
end
