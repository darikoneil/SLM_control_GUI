...
region_params(idx).xyz_affine_tf_fname = 'xyz_calib_25XL_coherent_03_15_25.mat';
...
idx = 1;
xyz_patterns(idx).pat_name = 'Imaging';
xyz_patterns(idx).xyz_pts = [0, 0, 0];
xyz_patterns(idx).SLM_region = 'Right half';

idx = idx + 1;
xyz_patterns(idx).pat_name = 'Stimulation';
xyz_patterns(idx).xyz_pts = [0, 0, 0];
